...
~~~
letters = ['a', 'b', 'c']
print(f'Letter #1 is {letters[0]}')
print(f'Letter #2 is {letters[1]}')
print(f'Letter #3 is {letters[2]}')
print(f'Letter #4 is {letters[3]}')
~~~
{: .language-python}
...
<ipython-input-11-d817f55b7d6c> in <module>()
      3 print(f'Letter #2 is  {letters[1]}')
      4 print(f'Letter #3 is  {letters[2]}')'
----> 5 print(f'Letter #4 is  {letters[3]}')
...
> > ~~~
> > seasons = ['Spring', 'Summer', 'Fall', 'Winter']
> > print(f'My favorite season is  {seasons[-1]}')
> > ~~~
> > {: .language-python}
> {: .solution}
{: .challenge}
